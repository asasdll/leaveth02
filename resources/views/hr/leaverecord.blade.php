                    ...
                    <div class="card strpied-tabled-with-hover">
                        <div class="card-header ">
                            ...
                            <form class="form-inline  pull-right my-2 my-lg-0" method="POST"
                                action="{{'search_leaves'}}">
                                @csrf
                                <input class="form-control mr-sm-2" type="search_leaves" name="search_leaves"
                                    placeholder="search" aria-label="Search">
                                <button class="btn btn-outline-info my-2 my-sm-0" type="submit">Search</button>
                            </form>
                            @php
                                 $name_member = empty($name) ? '' : $name;
                            @endphp

                                    @if($name_member != "")
                                        
                                    <a  target ="_blank"  href="{{url('pdf_leave', $name_member) }}"  class="btn btn-outline-info" role="button" aria-pressed="true">PDF</a>
                                        
                                    @else
                                        <a  target ="_blank" href="{{url('pdf_leave') }}"  data-toggle="modal" data-target="#pdf_leave" class="btn btn-outline-info" role="button" aria-pressed="true">PDF</a>
                                        ...
                                        <td>
                                            <div id="image">
                                                <a href="#modal" data-toggle="modal" data-target="#modalimage">
                                                    <img id="myImg"
                                                        src="{{ URL::to('/') }}/img/file/{{$ticket1->image}}"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">ประวัติการลา</h5>
...
<!-- Modal -->
<div class="modal fade" id="pdf_leave" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
